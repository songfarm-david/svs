		...
		<main>
			...
			<div class="container">
					<div class="row">
						...
						<article id="location">
							<h4 class="hidden">Address: Head Office</h4>
							<div class="col-sm-6 col-md-6 col-md-pull-6">

								<p class="h2">Corporate Head Office</p>
								<div class="row">
									<div class="col-lg-6">
										<a href="#" style="border:1px solid black; display:block;">
											<address class="">
									...
									<div class="col-lg-6">
										<span><span class="fa fa-phone"></span><a href="tel:+1-604-526-1086">(604) 526-1086</a></span>
										<br>
										<span><span class="fa fa-envelope"></span><a href="mailto:info@garagedoordepot.ca">info@garagedoordepot.ca</a></span>
									</div>
								</div>
